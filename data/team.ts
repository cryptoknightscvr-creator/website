...
export const teamMembers: TeamMember[] = [
  ...
  { id: "team-9", name: "Bala Aditya Reddy", role: "Vice-President" },
  { id: "team-11", name: "Sriyanjali Reddy", role: "Secretary" },
  { id: "team-12", name: "Khaja", role: "Treasurer" },
  { id: "team-13", name: "Maanas Patel", role: "MDO" },
  { id: "team-14", name: "Yashwanth Sama", role: "Graphic Designer" },
  { id: "team-15", name: "Madhuri Satvika", role: "Documentation" },
  { id: "team-16", name: "Nikitha", role: "Magazine-Tech" },
  { id: "team-17", name: "Venkat Sai", role: "Magazine-NonTech" },
  { id: "team-18", name: "Kkeshav", role: "Organizing committee" },
  { id: "team-19", name: "Aashish Betal", role: "Photography" },
  { id: "team-20", name: "Keerthana", role: "Social Media" },
  { id: "team-21", name: "Hrudayanshu", role: "Marketing" },
];
